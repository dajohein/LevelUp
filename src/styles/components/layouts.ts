...
export const ResponsiveGrid = styled.div<{
  ...
  /* Mobile first */
  grid-template-columns: repeat(${props => props.columns?.mobile || 1}, 1fr);
...
export const ResponsiveFlex = styled.div<{
  ...
  /* Tablet */
  @media (min-width: ${props => props.theme.breakpoints.tablet}) {
    flex-direction: ${props => props.direction?.tablet || props.direction?.mobile || 'row'};
  }

  /* Desktop */
  @media (min-width: ${props => props.theme.breakpoints.desktop}) {
    flex-direction: ${props => props.direction?.desktop || props.direction?.tablet || 'row'};
  }
`;
...
export const ResponsiveContainer = styled.div<{
  ...
  /* Mobile padding */
  padding: ${props => props.padding?.mobile || `0 ${props.theme.spacing.md}`};

  /* Tablet padding */
  @media (min-width: ${props => props.theme.breakpoints.tablet}) {
    padding: ${props =>
      props.padding?.tablet || props.padding?.mobile || `0 ${props.theme.spacing.lg}`};
  }

  /* Desktop padding */
  @media (min-width: ${props => props.theme.breakpoints.desktop}) {
    padding: ${props =>
      props.padding?.desktop || props.padding?.tablet || `0 ${props.theme.spacing.xl}`};
  }
`;
...
export const ResponsiveStack = styled.div<{
  ...
  /* Mobile */
  gap: ${props => props.gap?.mobile || props.theme.spacing.sm};

  /* Tablet */
  @media (min-width: ${props => props.theme.breakpoints.tablet}) {
    gap: ${props => props.gap?.tablet || props.gap?.mobile || props.theme.spacing.md};
  }

  /* Desktop */
  @media (min-width: ${props => props.theme.breakpoints.desktop}) {
    gap: ${props => props.gap?.desktop || props.gap?.tablet || props.theme.spacing.lg};
  }
`;
  ...
  ${props => {
    if (props.show) {
      return css`
        ...
        ${props.show.includes('tablet') &&
        css`
          @media (min-width: ${props.theme.breakpoints.tablet}) and (max-width: ${props.theme
              .breakpoints.desktop}) {
            display: block;
          }
        `}
        
        ${props.show.includes('desktop') &&
        css`
